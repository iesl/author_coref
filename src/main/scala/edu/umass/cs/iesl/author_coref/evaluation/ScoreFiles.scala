...
/**
  ...
  *
  * Usage:
  * java -Xmx20G -cp target/author_coref-1.1-SNAPSHOT-jar-with-dependencies.jar edu.umass.cs.iesl.author_coref.evaluation.ScoreFiles predicted_file gold_file [algorithm name]
  */
object ScoreFiles {
